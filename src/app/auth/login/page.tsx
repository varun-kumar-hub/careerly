...
export default function LoginPage() {
    const { signInWithGoogle, signInWithGithub, signInWithPassword, user, loading: authLoading } = useAuth();
    ...
    const handleSignIn = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                // Supabase returns "Invalid login credentials" for unverified emails too
                if (error.message.includes("Invalid login credentials")) {
                    throw new Error("Invalid credentials. If you just signed up, please verify your email.");
                }
                throw error;
            }
        } catch (err: any) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <Card className="w-full max-w-md p-8 bg-white border-gray-200 shadow-lg">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500">Sign in to continue to Careerly</p>
                </div>
